...
Gui, Add, Button, x12 y170 w200 h20 default gDocumentationWindow, Tokyo Z Documentation
...
SB_SetParts(85,270,190)
SB_SetText("Tokyo Z ",1)
...
~LButton:: 
	...
	Race_Tokyo()
	{
		...
		loop 12 
		{
			...
			if (TokyoLapCount <= 11)
			{
				if (TokyoLapCount = 2 or TokyoLapCount = 4 or TokyoLapCount >= 6)
				{
					location := "Pit entrace"
					guicontrol,, CurrentLoop, Current Location: %location%
					CheckMaxTime(maxTime, loopStartTime, TokyoLapCount)
